...
var $keyword = (function(){
    function getDefaults(params, callbacks) {
        ...
        var dc = {};
        dc['200'] = function(o){ return (o instanceof Configuration_InteractionAnalyzer.Keyword) ? o : new Configuration_InteractionAnalyzer.Keyword(o); };
    ...
    Object.defineProperties(getDefaults, {
        ...
        'urlTemplate': { value: '/icws/{sessionId}/configuration/defaults/keyword', enumerable: true }
    });
